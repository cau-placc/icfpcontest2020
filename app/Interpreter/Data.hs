...
data Data = Partial (AlienExpr -> MIB Data) | Part AlienFunc [AlienExpr] | Int Integer | Pair AlienExpr AlienExpr | Unit | Pic [(Integer, Integer)] | Modulated String deriving (Show)
